/**
 * Loading State for Human Interview Room List Page (/human)
 * 
 * Originally located at: app/human/loading.tsx
 * Moved to: components/human/HumanRoomListLoading.tsx (January 16, 2026)
 * 
 ...
 * Moved to components in codebase reorganization
 */
...
export default function HumanRoomListLoading() {
  return (
